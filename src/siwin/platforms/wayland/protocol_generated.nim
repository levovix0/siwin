...
type
  ...
  Zwp_tablet_v2* = object
    ...
    proxy*: Wl_proxy
  `Zwp_tablet_v2 / Bustype`* {.size: 4.} = enum ## Describes the bus types this tablet is connected to.
    usb = 3, bluetooth = 5, virtual = 6, serial = 17, i2c = 24
  `Zwp_tablet_v2 / Callbacks`* = object
    ...
    removed*: proc ()
    bustype*: proc (bustype: `Zwp_tablet_v2 / Bustype`)
  ...
  `Zwp_tablet_pad_group_v2 / Callbacks`* = object
    ...
    dial*: proc (dial: Zwp_tablet_pad_dial_v2)
  ...
  WaylandInterfaces* = object
    ...
    `iface Zwp_tablet_pad_dial_v2`*: WlInterface
...
proc initInterfaces*(interfaces: var WaylandInterfaces) =
  ...
  interfaces.`iface Zwp_tablet_manager_v2` = newWlInterface(
      "zwp_tablet_manager_v2", 2, [newWlMessage(
  ...
  interfaces.`iface Zwp_tablet_seat_v2` = newWlInterface("zwp_tablet_seat_v2",
      2, [newWlMessage("zwp_tablet_seat_v2.destroy", "1", [])], [newWlMessage(
  ...
  interfaces.`iface Zwp_tablet_tool_v2` = newWlInterface("zwp_tablet_tool_v2",
      2, [newWlMessage("zwp_tablet_tool_v2.set_cursor", "1u?oii", [
  ...
  interfaces.`iface Zwp_tablet_v2` = newWlInterface("zwp_tablet_v2", 2,
      ...
      newWlMessage("zwp_tablet_v2.bustype", "1u", [(ptr WlInterface) nil])])
  interfaces.`iface Zwp_tablet_pad_ring_v2` = newWlInterface(
      "zwp_tablet_pad_ring_v2", 2, [newWlMessage(
  ...
  interfaces.`iface Zwp_tablet_pad_strip_v2` = newWlInterface(
      "zwp_tablet_pad_strip_v2", 2, [newWlMessage(
  ...
  interfaces.`iface Zwp_tablet_pad_group_v2` = newWlInterface(
      ...
      "zwp_tablet_pad_group_v2.dial", "1n",
      [addr(interfaces.`iface Zwp_tablet_pad_dial_v2`)])])
  interfaces.`iface Zwp_tablet_pad_v2` = newWlInterface("zwp_tablet_pad_v2", 2, [newWlMessage(
  ...
  interfaces.`iface Zwp_tablet_pad_dial_v2` = newWlInterface(
      "zwp_tablet_pad_dial_v2", 2, [newWlMessage(
      "zwp_tablet_pad_dial_v2.set_feedback", "1su",
      [(ptr WlInterface) nil, (ptr WlInterface) nil]), newWlMessage(
      "zwp_tablet_pad_dial_v2.destroy", "1", [])], [newWlMessage(
      "zwp_tablet_pad_dial_v2.delta", "1i", [(ptr WlInterface) nil]), newWlMessage(
      "zwp_tablet_pad_dial_v2.frame", "1u", [(ptr WlInterface) nil])])
  ...
  interfaces.`iface Wl_registry` = newWlInterface("wl_registry", 1, [newWlMessage(
      "wl_registry.bind", "1usun", [(ptr WlInterface) nil,
                                    (ptr WlInterface) nil,
                                    (ptr WlInterface) nil, (ptr WlInterface) nil])], [newWlMessage(
...
template ifaceName*(t: typedesc[Zwp_tablet_pad_dial_v2]): string =
...
proc `Zwp_tablet_v2 / dispatch`*(impl: pointer; obj: pointer; opcode: uint32;
  ...
  of 5:
    let argsArray = cast[ptr array[1, Wl_argument]](args)
    if callbacks.bustype != nil:
      callbacks.bustype(cast[`Zwp_tablet_v2 / Bustype`](argsArray[][0]))
  else:
    discard
...
proc `Zwp_tablet_pad_group_v2 / dispatch`*(impl: pointer; obj: pointer;
  ...
  of 6:
    let argsArray = cast[ptr array[1, Wl_argument]](args)
    if callbacks.dial != nil:
      callbacks.dial(cast[Zwp_tablet_pad_dial_v2](argsArray[][0]))
  else:
    discard
...
proc `Zwp_tablet_pad_dial_v2 / dispatch`*(impl: pointer; obj: pointer;
    opcode: uint32; msg: ptr WlMessage; args: pointer): int32 {.cdecl.} =
  let callbacks = cast[ptr `Zwp_tablet_pad_dial_v2 / Callbacks`](impl)
  case opcode
  of 0:
    let argsArray = cast[ptr array[1, Wl_argument]](args)
    if callbacks.delta != nil:
      callbacks.delta(cast[int32](argsArray[][0]))
  of 1:
    let argsArray = cast[ptr array[1, Wl_argument]](args)
    if callbacks.frame != nil:
      callbacks.frame(cast[uint32](argsArray[][0]))
...
proc set_feedback*(this: Zwp_tablet_pad_dial_v2; description: cstring;
                   serial: uint32) =
  ## Requests the compositor to use the provided feedback string
...
proc destroy*(this: Zwp_tablet_pad_dial_v2) =
...
template onBustype*(this: Zwp_tablet_v2; body) =
  ...
  ## This event is sent in the initial burst of events before the
  ## zwp_tablet_v2.done event.
  cast[ptr `Zwp_tablet_v2 / Callbacks`](this.proxy.raw.impl).bustype = proc (
      bustype {.inject.}: `Zwp_tablet_v2 / Bustype`) =
    body
...
template onDial*(this: Zwp_tablet_pad_group_v2; body) =
  ...
  ## This event is sent in the initial burst of events before the
  ## zwp_tablet_pad_group_v2.done event.
  cast[ptr `Zwp_tablet_pad_group_v2 / Callbacks`](this.proxy.raw.impl).dial = proc (
      dial {.inject.}: Zwp_tablet_pad_dial_v2) =
    body
...
template onDelta*(this: Zwp_tablet_pad_dial_v2; body) =
  ...
  cast[ptr `Zwp_tablet_pad_dial_v2 / Callbacks`](this.proxy.raw.impl).delta = proc (
      value120 {.inject.}: int32) =
    body

template onFrame*(this: Zwp_tablet_pad_dial_v2; body) =
  ## Indicates the end of a set of events that represent one logical
  ...
  ## delta, frame, etc.
  cast[ptr `Zwp_tablet_pad_dial_v2 / Callbacks`](this.proxy.raw.impl).frame = proc (
      time {.inject.}: uint32) =
    body
...
template dispatch*(t: typedesc[Zwp_tablet_pad_dial_v2]): untyped =
  `Zwp_tablet_pad_dial_v2 / dispatch`
...
template Callbacks*(t: typedesc[Zwp_tablet_pad_dial_v2]): untyped =
  `Zwp_tablet_pad_dial_v2 / Callbacks`
